...
int main()
{
    ...
    auto light = std::make_shared<DiffuseLight>(Color(7.));
    ...
    world.Add(std::make_shared<Quadrilateral>(
        Point3{113., 554., 127.}, Vector3{330., 0., 0.}, Vector3{0., 0., 305.}, light));
    world.Add(std::make_shared<Quadrilateral>(
    ...
    world.Add(std::make_shared<ConstantMedium>(box1, 0.01, Color{0.}));
    ...
    world.Add(std::make_shared<ConstantMedium>(box2, 0.01, Color{1.}));
